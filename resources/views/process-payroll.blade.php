...
<div class="container-fluid mb-3">
    <div class="card wow fadeInUp shadow-sm" data-wow-delay="0.1s">
        <div class="card-header bg-primary text-white fw-1">{{ __('Process Payrolls') }}</div>
        <div class="card-body">
            {{-- <a class="breadcrumb-link" data-bs-toggle="modal" data-bs-target="#printPayrollModal" href="#">
                Process Payroll
            </a> --}}
