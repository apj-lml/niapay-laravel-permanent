...
@endsection
    ...
    <div class="container-fluid">
        <div class="card wow fadeInUp shadow-sm" data-wow-delay="0.1s">
            <div class="card-header bg-primary text-white fw-1">{{ __('Generate FINDES') }}</div>
            <small class="animated zoomIn m-2 text-danger">*This will generate FINDES. Please be mindful of the Payroll Period selected.</small>
            ...
            <div class="card-body col-sm-5 mx-auto">
                ...
                @livewire('findes-generator-component')
