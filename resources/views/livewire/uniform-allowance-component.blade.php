                                        ...
                                        <table
                                                ...
                                                <thead class="my-sticky-top">
                                                    <tr>
                                                        ...
                                                        <th scope="col"
                                                            class="text-center align-middle" style="width:5%">Uniform Allowance for CY {{ $year }}
                                                        </th>
                                                        <th scope="col"
                                                        ...
                                                        @if ($office == $payrollUser->agencyUnit()->with('agencySection')->first()->toArray()['agency_section']['office'])
                                                            ...
                                                            <tr
                                                                ...
                                                                <td scope="row"
                                                                    ...
                                                                    @livewire('uniform-allowance-input-component', [
                                                                        'payrollUser'=>$payrollUser, 'year' => $year,
                                                                        ], key('uniform-allowance-input-component' . $payrollUser->id))
                                                                </td>
                                               

                                                                <td
                                                                    class="text-center align-middle p-0">
                                                                    @livewire('uniform-allowance-remarks-component', [
                                                                        'payrollUser'=>$payrollUser, 
                                                                        'year' => $year
                                                                        ], key('uniform-allowance-remarks-component' . $payrollUser->id))
                                                                </td>
                                                            </tr>
                                                            @endif
                                                        @endif
...
<script type="text/javascript">
    ...
    window.addEventListener('previewUniformAllowancePdf', event => {
