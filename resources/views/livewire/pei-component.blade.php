                                        ...
                                        <table
                                                ...
                                                <thead class="my-sticky-top">
                                                    <tr>
                                                        ...
                                                        <th scope="col"
                                                            class="text-center align-middle" style="width:5%">Productivity Enhancement Incentive (PEI) for CY {{ $year }}
                                                        </th>
                                                        <th scope="col"
                            ...
                            {{-- @foreach ($payrollUserSections as $payrollUserSection) --}}
                                                        ...
                                                        @if ($office == $payrollUser->agencyUnit()->with('agencySection')->first()->toArray()['agency_section']['office'])
                                                            ...
                                                            <tr
                                                                ...
                                                                <td scope="row"
                                                                    ...
                                                                    @livewire('pei-input-component', [
                                                                        'payrollUser'=>$payrollUser, 'year' => $year,
                                                                        ], key('pei-input-component' . $payrollUser->id))
                                                                </td>
                                               

                                                                <td
                                                                    class="text-center align-middle p-0">
                                                                    @livewire('pei-remarks-input-component', [
                                                                        'payrollUser'=>$payrollUser, 
                                                                        'year' => $year
                                                                        ], key('peiRemarks' . $payrollUser->id))
                                                                </td>
                                                            </tr>
                                                            @endif
                                                        @endif
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td colspan=2 class="text-start"><b>{{ number_format(bcdiv((float) $total_pei, 1, 2), 2) }}</b></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
...
<script type="text/javascript">
    ...
    window.addEventListener('previewPeiPdf', event => {
