...
<style type="text/css">
 ...
 /* @page { size: 21cm 29.7cm landscape; margin-top: 0;} A4 */
 @page { size: 21.59cm 33.02cm landscape; margin-top: 0; }  /* LEGAL */
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="header-container">
                                      ...
                                      <div style="margin-left: 5px; margin-bottom: 3px; margin-top: 15px;">
                                    ...
                                    <caption>
                                        ...
                                        <div class="col-sm-12">
                                            <span class="fw-sm text-start" style="font-size: 7px;">
                                                ...
                                                @foreach ($payrollUsers as $payrollUser)
                                                    @if($payrollUser->cnas->where('year', $year)->first()->mc != "" && $payrollUser->cnas->where('year', $year)->first()->mc != null)
                                                        {{ $payrollUser->cnas->where('year', $year)->first()->mc }}
                                                    @else
                                        ...
                                        <div class="col-sm-12">
                                            <i class="fw-sm" style="font-size: 7px;">COLLECTIVE NEGOTIATION AGREEMENT (CNA) INCENTIVE FOR CY {{ $year }}</i>
                                        </div>
                                          </div>
                                        <table class="main-table">
                                            <thead class="sticky-top">
                                                <tr>
                                                    ...
                                                    <th scope="col"
                                                        class="text-center align-middle" style="width:26%">POSITION TITLE / JG
                                                    </th>
                                                    <th scope="col"
                                                        class="text-center align-middle" style="width:11%">COLLECTIVE NEGOTIATION AGREEMENT (CNA) INCENTIVE FOR CY {{ $year }}
                                                    </th>
                                                    <th scope="col"
                                                        class="text-center align-middle" style="width:8%">NO. OF MONTHS RENDERED
                                                    </th>
                                                    <th scope="col"
                                                        class="text-center align-middle" style="width:10%">AMOUNT DUE
                                                    </th>
                                                    <th scope="col"
                                                        class="text-center align-middle" style="width:20%">REMARKS
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @foreach ($payrollUsers as $payrollUser)
                                                {{-- @if ($payrollFund->id == $payrollUser->fund_id) --}}
                                                   ...
                                                   @php
                                                        ...
                                                        $niaMc = $payrollUser->cnas->where('year', $year)->first()->mc
                                                   @endphp
                                                    ...
                                                    @endphp
                                                        ...
                                                        <td scope="row" style="width: 50px;"
                                                            ...
                                                            <div class="form-switch w-0 p-0 pt-1" style="text-align: center;">
                                                                <span
                                                                    style="">{{ $counter }}</span>
                                                                <br>
                                                        ...
                                                        <td scope="row"
                                                            class="text-center align-middle p-0" style="text-align: center;">
                                                            {{ number_format((float)$payrollUser->cnas->where('year', $year)->first()->cna, 2) }}
                                                        </td>

                                                        <td scope="row"
                                                            class="text-center align-middle p-0" style="text-align: center;">
                                                            {{ number_format((float)$payrollUser->cnas->where('year', $year)->first()->no_mos, 3) }}
                                                        </td>
                                                        <td scope="row"
                                                            class="text-center align-middle p-0" style="text-align: center;">
                                                        ...
                                                        <td
                                                            ...
                                                            {{ $payrollUser->cnas->where('year', $year)->first()->remarks }}
