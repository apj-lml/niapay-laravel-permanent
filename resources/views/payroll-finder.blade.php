...
@endsection
    ...
    <div class="container-fluid mb-3">
        <div class="card wow fadeInUp shadow-sm" data-wow-delay="0.1s">
            <div class="card-header bg-primary text-white fw-1">{{ __('Search Employees Without Deductions') }}</div>
            <div class="card-body">
                @livewire('list-of-employees-without-deduction-component')
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card wow fadeInUp shadow-sm" data-wow-delay="0.1s">
            <div class="card-header bg-primary text-white fw-1">{{ __('Find Employees Not Included to Payroll') }}</div>
            <div class="card-body">
                @livewire('show-employees-without-payroll')
            </div>
        </div>
    </div>
