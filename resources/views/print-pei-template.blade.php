                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <caption>
                                        ...
                                        <div class="col-sm-12">
                                            <span class="fw-sm text-start" style="font-size: 7px;">
                                                @foreach ($payrollUsers as $payrollUser)
                                                    @if($payrollUser->peis->where('year', $year)->first()->mc != "" && $payrollUser->peis->where('year', $year)->first()->mc != null)
                                                        {{ $payrollUser->peis->where('year', $year)->first()->mc }}
                                                    @else
                                        ...
                                        <div class="col-sm-12">
                                            <i class="fw-sm" style="font-size: 7px;">PRODUCTIVITY ENHANCEMENT INCENTIVE (PEI) FOR CY {{ $year }}</i>
                                        </div>
                                          </div>
                                        <table class="main-table">
                                            <thead class="sticky-top">
                                                <tr>
                                                    ...
                                                    <th scope="col" style="width:15%"
                                                        class="text-center align-middle">PRODUCTIVITY ENHANCEMENT INCENTIVE (PEI)
                                                    </th>
                                                    <th scope="col" style="width:25%"
                                            ...
                                            @foreach ($payrollUsers as $payrollUser)
                                                {{-- @if ($payrollFund->id == $payrollUser->fund_id) --}}
                                                   ...
                                                   @php
                                                        $counter = $counter + 1;
                                                        $total_pei += $payrollUser->peis->where('year', $year)->first()->pei;
                                                   ...
                                                   @endphp
                                                    ...
                                                    @endphp
                                                        ...
                                                        <td scope="row" style="text-align: center;"
                                                            ...
                                                            {{ number_format((float)$payrollUser->peis->where('year', $year)->first()->pei, 2) }}
                                                        </td>
                                                        <td
                                                            class="text-center align-middle p-0">
                                                            {{ $payrollUser->peis->where('year', $year)->first()->remarks }}
