            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Authentication Error!</h1>
                        <p class="mb-4">We're sorry, you do not have access to this page! Please login first or contact system administrator for assistance.</p>
